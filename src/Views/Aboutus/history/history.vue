      ...
      <div class="modal__panel">
        ...
        <div class="modal__content">
          ...
          <div class="modal__nav">
            ...
            <button class="navBtn" type="button" :disabled="activeIndex >= steps.length - 1" @click="openStep(steps[activeIndex + 1])">
              Next →
            </button>
          </div>
        </div>
...
.node:nth-child(1){ left: 220px; }
.node:nth-child(2){ left: 660px; }
.node:nth-child(3){ left: 1100px; }
.node:nth-child(4){ left: 1540px; }
.node:nth-child(5){ left: 1980px; }
.node:nth-child(6){ left: 2420px; }
...
.node__hit:active{ transform: translateY(0px) scale(0.99); }
...
.badge{ display:flex; align-items: baseline; gap: 10px; }
.badge__n{ font-weight: 900; font-style: italic; font-size: 28px; color: var(--c); }
.badge__t{ font-weight: bold; font-size: 1.2rem; color: rgba(40,40,55,0.86); }
.x{ border:0; background: rgba(0,0,0,0.06); border-radius: 12px; width: 40px; height: 40px; cursor:pointer; }

.modal__content{ padding: 16px; }
.modal__text{ margin: 0 0 14px; color: rgba(40,40,55,0.78); line-height: 1.7; }

.modal__meta{ display:grid; grid-template-columns: 1fr 1fr; gap: 12px; }
@media (max-width: 720px){ .modal__meta{ grid-template-columns: 1fr; } }
...
.metaTitle{ font-weight: 900; color: rgba(40,40,55,0.86); margin-bottom: 8px; }
.metaList{ margin: 0; padding-left: 18px; color: rgba(40,40,55,0.70); line-height: 1.7; font-size: 14px; }
.pillRow{ display:flex; gap: 8px; flex-wrap: wrap; }
.pill{ padding: 8px 10px; border-radius: 999px; font-size: 12px; font-weight: 800; background: var(--c); color: white; }
.pill.ghost{ background: rgba(0,0,0,0.06); color: rgba(40,40,55,0.8); }
.small{ margin-top: 10px; font-size: 13px; color: rgba(40,40,55,0.65); }

.modal__nav{ display:flex; justify-content: space-between; margin-top: 14px; }
.navBtn{ border: 0; cursor: pointer; border-radius: 14px; padding: 10px 12px; background: rgba(0,0,0,0.06); font-weight: 800; }
.navBtn:disabled{ opacity: 0.45; cursor: not-allowed; }

/* responsive: make it still usable */
@media (max-width: 980px){
  .track, .nodes, .road{ width: 2800px; }
  .node__hit{ width: 340px; }
}
</style>
