    ...
    <div class="org-container" ref="root">
      ...
      <header class="org-header">
        <div class="org-header-left">
          <!-- ชื่อหัวข้อให้เหมือนภาพ: ພະແນກບັນຊີ ແລະ ການເງິນ -->
...
const rows = [
  ...
  [
    {
      id: 1,
      name: 'ທ່ານ ວັດດະນາ ວິລະบຸດ',
      role: 'ຫົວໜ້າພະແນກບັນຊີ ແລະ ການເງິນ',
      photo: '/finance/head.png'
    }
  ],
  // row 1 – 2 คน
  [
    {
      id: 2,
      name: 'ທ່ານ ອຸມມີ ສັດຕະວະເລີຍສິນ',
      role: 'ບັນຊີ',
      photo: '/finance/account-1.png'
    },
    {
      id: 3,
      name: 'ນາງ ມາຣີ ປາເຊີເຣ ວົງສາ',
      role: 'ການປະຕິບັດງານທາງການເງິນ',
      photo: '/finance/account-2.png'
    }
  ],
  // row 2 – 1 คน
  [
    {
      ...
      role: 'ພາກປະຕິບັດແລະສະໜັບສະໜູນ',
      photo: '' // ยังไม่มีรูป → ใช้ placeholder
    }
  ]
]
