  ...
  <div class="lapnet-org-chart">
    ...
    <section class="chart-wrapper">
      ...
      <div class="node two-line-node board-node">
        ...
        <div class="node-bottom">Board of director</div>
      </div>
      ...
      <div class="row committees-row">
        <div class="node two-line-node">
          <div class="node-top">ຄະນະກຳມະການວິຈັຍນະໂຍບາຍ</div>
        ...
        <div class="node two-line-node">
          <div class="node-top">ຄະນະກຳມະການກວດສອບ</div>
      ...
      <div class="row departments-row">
        ...
        <div class="department">
          <div class="department-head">
            <div class="node-top">ພະແນກບໍລິຫານງານ</div>
            <div class="node-bottom">Administration</div>
          </div>
          <div class="department-body">
            <ul>
              <li>ບຸກຄະລາກອນ</li>
              <li>ສັງຄົມ ແລະ ສະພາບແວດລ້ອມ</li>
              <li>ນິຕິກຳ</li>
              <li>ເລຂາທິການ</li>
              <li>ບໍາລຸງຮັກສາ ແລະ ຊັບສິນຖາວອນ</li>
            </ul>
          </div>
        </div>
        ...
        <div class="department">
          ...
          <div class="department-body">
            <ul>
              <li>ບັນຊີ</li>
              <li>ການວິເຄາະການເງິນ</li>
              <li>ການປະຕິບັດງານທົ່ວໄປ</li>
            </ul>
          </div>
        </div>
        ...
        <div class="department">
          ...
          <div class="department-body">
            <ul>
              <li>ອອກແບບ ແລະ ພັດທະນາລະບົບ</li>
              <li>ພັດທະນາ ແລະ ດູແລລະບົບອຸປະກອນ</li>
              <li>ຄວາມປອດໄພທາງໄອທີ</li>
              <li>ດູແລ ແລະ ບໍາລຸງຮັກສາອຸປະກອນ</li>
              <li>ລະບົບສະກຸນຂໍ້ມູນຕ່າງໆ</li>
            </ul>
          </div>
        </div>
        ...
        <div class="department">
          ...
          <div class="department-body">
            <ul>
              <li>ໂຕລະບຽບ, ຂໍ້ກໍານົດ ແລະ ແກ້ໄຂຂໍ້ຂັດແຍ່ງ</li>
              <li>ການບໍລິການ</li>
              <li>ການກວດກາຂັ້ນຕອນດໍາເນີນງານ</li>
              <li>ການບໍລິຫານຄ່າທໍານຽມແລະຄ່າບໍລິການ</li>
            </ul>
          </div>
        </div>
