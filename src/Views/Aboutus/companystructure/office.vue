    ...
    <div class="org-container" ref="root">
      ...
      <header class="org-header">
        <div class="org-header-left">
          <h1 class="org-title-lao">ພະແນກກົດຫມາຍ</h1>
        </div>
...
const rows = [
  [
    {
      id: 1,
      name: 'ທ່ານ ສິນິພາບ ປານມະໂລງດ',
      role: 'ຫົວໜ້າພະແນກກົດຫມາຍ',
      photo: '/legal/head.png'
    }
  ],
  [
    {
      id: 2,
      name: 'ນາງ ວິຈິດພອນ ເພັດສະຫວັດ',
      role: 'ຮອງຫົວໜ້າພະແນກກົດຫມາຍ',
      photo: '/legal/deputy.png'
    }
  ],
  [
    {
      id: 3,
      name: 'ທ່ານ ສຸກນະວົງ ນານວິລັດ',
      role: 'ບໍລິຫານ–ສັງຄົມ',
      photo: '/legal/left.png'
    },
    {
      id: 4,
      name: 'ນາງ ໂພນສະຫວັນ ສີສະຫວັດ',
      role: 'ນິຕິກຳ',
      photo: '/legal/middle.png'
    },
    {
      id: 5,
      name: 'ນາງ ປາດິດາ ດວງພອນສາ',
      role: 'ເລຂາທິການ',
      photo: '/legal/right.png'
    }
  ],
  [
    {
      id: 6,
      name: 'ນາງ ດາວິນ ບຸນສະຫວັນ',
      role: 'ບຸກຄະລາກອນ',
      photo: ''
    }
  ]
...
/* ROWS – ทุกแถวห่างกัน 76px (desktop) */
.org-row {
  display: flex;
  justify-content: center;
  gap: 42px;
