...
/**
 * โครงสร้างใหม่ให้เหมือนรูป IT:
 *  row 0: 1 คน (หัวหน้า)
 *  row 1: 3 คน
 *  row 2: 4 คน
 *  (เปลี่ยนชื่อ / รูป / ตำแหน่งได้ตามจริง)
 */
const rows = [
  // row 0 – หัวหน้าแผนก
  [
    {
      id: 1,
      name: 'ທ່ານ ພູເລິນວົງ ພິຈວົງ', // ตัวอย่าง: หัวหน้า IT
      role: 'ຫົວໜ້າພະແນກໄອທີ',
      photo: '/it/it-head.jpg'
    }
  ],
  // row 1 – 3 คน (สายงานหลัก)
  [
    {
      id: 2,
      name: 'ທ່ານ ສຸກສະຫວັນ ບຸນມະວົງ',
      role: 'ຝ່າຍບໍລິຫານລະບົບໂຄງສ້າງພື້ນຖານ',
      photo: '/it/infra-1.jpg'
    },
    {
      id: 3,
      name: 'ທ່ານ ເອ່ຍຄຳ ແກ້ວສີ',
      role: 'ຝ່າຍພັດທະນາຊອບແວ & ແອັບຯ',
      photo: '/it/dev-1.jpg'
    },
    {
      id: 4,
      name: 'ນາງ ມານີ ພອນພິມ',
      role: 'ຝ່າຍບໍລິຫານຖານຂໍ້ມູນ ແລະ ຄວາມປອດໄພ',
      photo: '/it/security-1.jpg'
    }
  ],
  // row 2 – 4 คน (เจ้าหน้าที่)
  [
    {
      id: 5,
      name: 'ທ່ານ ສົມສະໄຫມ ສັນຕະວົງ',
      role: 'ພະນັກງານຊ່ວຍເຫຼືອລະບົບ',
      photo: '' // ยังไม่มีรูป → ใช้ avatar placeholder
    },
    {
      id: 6,
      name: 'ທ່ານ ອານຸໄຊ ສີຣິໂລ',
      role: 'ພະນັກງານພັດທະນາຊອບແວ',
      photo: ''
    },
    {
      id: 7,
      name: 'ນາງ ສຸກສິດາ ມະນິດ',
      role: 'ພະນັກງານຖານຂໍ້ມູນ',
      photo: ''
    },
    {
      id: 8,
      name: 'ທ່ານ ວິລະວັດ ແກ້ວວົງ',
      role: 'ພະນັກງານສະໜັບສະໜູນ',
      photo: ''
    }
  ]
]
...
@media (max-width: 640px) {
  ...
  /* ⬇️ แก้ตรงนี้ให้ 1 column แล้วมีช่องว่างระหว่าง box ชัดเจน */
  .org-row {
    flex-direction: column;
    align-items: center;
    gap: 120px;        /* ระยะห่างแนวตั้งระหว่างการ์ดใน row เดียวกัน */
