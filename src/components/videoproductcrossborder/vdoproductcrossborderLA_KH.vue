        ...
        <div class="content">
            <div class="glass-card">
                <div class="topcontainer">
                    <h1>
                        ລາວ <img src="https://flagcdn.com/la.svg" alt="" /> ສະແກນຊຳລະ ກຳປູເຈຍ
                        <img src="https://flagcdn.com/kh.svg" alt="" />: ນັກທ່ອງທ່ຽວລາວຊຳລະຢູ່ກຳປູເຈຍ
                    </h1>
                </div>
                <div class="centercontainer">
                    <div class="headercondition">
                        <p>ເບື້ອງລາວ (ສະແກນຊຳລະ) : 6 ທະນາຄານສະມາຊິກ</p>
                    </div>
                ...
                <div class="bottomcontainer">
                    <div class="headercondition">
                        <p style="font-size: 25px">
                            ເບື້ອງກຳປູເຈຍ (ຮັບການຊຳລະ) : ທຸກທະນາຄານໃນເຄືອຂ່າຍ Bakong (59 ທະນາຄານ) ແລະ QR ສະເພາະຂອງທະນາຄານ ACLEDA ກຳປູເຈຍ.
                        </p>
                    </div>
