    ...
    <div class="menu-container">
            ...
            <transition name="slide">
                <div v-show="open1" class="dropdown-content" @click="goTop()">
                    <router-link to="/membercard/member1" class="menu-item" >ກວດຍອດເງິນຂ້າມທະນາຄານຜ່ານຕູ້ ATM</router-link>
                    <router-link to="/membermobilebanking/member2_1" class="menu-item">ຖອນເງິນສົດຂ້າມທະນາຄານຜ່ານຕູ້ ATM</router-link>
                    <router-link to="/membercrossborder/member3_1" class="menu-item">ໂອນເງິນຂ້າມທະນາຄານຜ່ານຕູ້ ATM</router-link>
                    <router-link to="/membercrossborder/member3_1" class="menu-item">ໂອນເງິນຂ້າມທະນາຄານເທິງມືຖື</router-link>
                    <router-link to="/membercrossborder/member3_1" class="menu-item">ການຊຳລະເງິນຂ້າມທະນາຄານຜ່ານ QR</router-link>
                    <router-link to="/membercrossborder/member3_1" class="menu-item">ຊຳລະຂ້າມແດນໃນຮູບແບບ QR CODE ລະຫວ່າງປະເທດ</router-link>
        ...
        <div class="menu-section">
            ...
            <transition name="slide">
                <div v-show="open4" class="dropdown-content" @click="goTop()">
                    <router-link to="/vision_mission" class="menu-item">ວິໄສທັດ ແລະ ພາລະກິດ</router-link>
                    <router-link to="/Role" class="menu-item">ພາລະບົດບາດ</router-link>
                    <router-link to="/History" class="menu-item">ຄວາມເປັນມາ</router-link>
                    <router-link to="/board_of_director" class="menu-item">ສະພາຜູ້ບໍລິຫານ</router-link>
                    <router-link to="/companystructure" class="menu-item">ໂຄ່ງຮ່າງການຈັດຕັ້ງ</router-link>
