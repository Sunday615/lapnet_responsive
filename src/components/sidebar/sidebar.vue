<template>
  ...
  <li
    class="sidebar-item has-children"
    :class="{ 'is-open': openKey === 'product' }"
  >
    ...
    >
      ...
      <li class="sidebar-subitem" @click.stop>ການຊຳລະເງິນຂ້າມທະນາຄານຜ່ານ QR</li>
      <li class="sidebar-subitem" @click.stop>ຊຳລະຂ້າມແດນໃນຮູບແບບ QR CODE ລະຫວ່າງປະເທດ</li>
    </ul>
  </li>
  ...
  >
    ...
    <ul
      ...
      class="sidebar-subnav"
    >
      <li class="sidebar-subitem" @click.stop>ສະມາຊິກລະບົບບັດທະນາຄານຮ່ວມກັນ</li>
      <li class="sidebar-subitem" @click.stop>ສະມາຊິກລະບົບຊຳລະຂ້າມທະນາຄານເທິງມືຖື</li>
      <li class="sidebar-subitem" @click.stop>ສະມາຊິກລະບົບຊຳລະຂ້າມແດນໃນຮູບແບບ QR Code ລະຫວ່າງປະເທດ</li>
    </ul>
  </li>
  ...
  >
    ...
    >
      ...
      <li class="sidebar-subitem" @click.stop>ໂຄງຮ່າງການຈັດຕັ້ງ</li>
    </ul>
  </li>
    <li class="sidebar-item">
    <span class="sidebar-dot"></span>
...
.has-children {
  ...
  display: flex;
  flex-direction: column;   /* ⬅️ ทำให้ด้านในเรียงลงมา 1 column */
  align-items: stretch;
  padding: 0;               /* padding จะไปอยู่ที่ .sidebar-item-main แทน */
}
.sidebar-item-main {
  display: flex;
  align-items: center;
...
.sidebar-wrapper {
  position: fixed;
  inset: 0;
  pointer-events: none; /* interactions controlled by children */
  z-index: 999;
}
